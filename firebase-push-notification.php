			...
			<div class="row">
				<div class="col-lg-6">
					...
					<form action="" method="post">
						...
						<div class="checkbox">
							<label><input type="checkbox" id="include_action" name="include_action">Include Action Open Url</label>
						</div>
						...
						<div class="form-group" style="display: none" id="action_destination_group">
							...
							<input type="text" class="form-control" id="action_destination" placeholder="Enter Destination URL " name="action_destination">
						</div>
				...
				<div class="col-lg-6">
					...
					if(isset($_POST['title'])){
						...
						$topic = $_POST['topic'];
						if($sound ==''){
							$requestData = $notification->getNotifiNoSound();
						}else $requestData = $notification->getNotificatin();
